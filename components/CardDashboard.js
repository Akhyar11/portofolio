...
export default function CardDashboard({ className, content }) {
  ...
  return (
    <div
      ...
      className={`hover:scale-105 hover:cursor-pointer transtition-all duration-300 flex items-center justify-center w-[200px] rounded-md ${className} shadow-lg h-[200px]`}
    >
